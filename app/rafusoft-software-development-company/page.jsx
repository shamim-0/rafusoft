      ...
      <div>
        <div className="bradcamp-keyboard pb-20">
          ...
          <div className="text-center mt-20">
            <a href="#content" className="bg-[#F15A29] hover:text-white text-white font-bold rounded border-2 border-white px-4 py-2"><i className="fa fa-arrow-down scale-150 animate-bounce"></i></a>
          </div>
        </div>
